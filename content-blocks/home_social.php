...
<div class="row marg">
	<div class="col-xs-12">
		<h2>Get Social With Us</h2>
		  <?php if( is_okc() ) : ?>
			<p class="lead">We’re always entertaining on <a href="https://www.facebook.com/nighttripsokc">Facebook</a>, <a href="https://twitter.com/nighttripsokc">Twitter</a> and <a href="https://www.youtube.com/user/nighttripstv">Youtube</a>. Like our beer? Check out our list of our <a href="https://nighttrips.com/OKC/craft-beer/craft-beer-list">Favorite Craft Brews</a>.</p>
		  <?php else : ?>
