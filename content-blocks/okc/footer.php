      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-3">
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="">
            <img src="https://nighttrips.com/OKC/wp-content/uploads/2015/10/logo-okc.png" alt="<?php bloginfo( 'name' ); ?>" class="center-block marg" >          
          </a>
          <a href="https://nighttrips.com/Tulsa" class="">
            <img src="https://nighttrips.com/Tulsa/wp-content/uploads/2015/10/logo-tulsa.png" alt="<?php bloginfo( 'name' ); ?>" class="center-block" >
          </a>          
        </div>
